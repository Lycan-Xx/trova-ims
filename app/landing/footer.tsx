...
// ── Social link data ─────────────────────────────────────────────────────────
// Keeping SVG paths inline avoids an extra icon library import in the footer.
...
export default function Footer() {
  return (
    <footer
      className="border-t px-6 md:px-10 pt-12 pb-8"
      style={{ borderColor: 'var(--border)' }}
    >
      <div className="max-w-7xl mx-auto">

        {/* ── Top row ─────────────────────────────────────────────── */}
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-10 md:gap-20 mb-10">
        ...
        <div
          className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 border-t pt-6"
          style={{ borderColor: 'var(--border)' }}
        >
